...
const MSG = {
  ...
  // AI 채팅
  chatWelcome: `안녕하세요! 👋<br>모여행 AI 추천봇입니다.<br><br><strong>아래처럼 여행 정보를 알려주세요:</strong><br>📍 <em>"제주도 3박 4일, 4인 가족 여행 추천해줘"</em><br>📍 <em>"부산 당일치기, 친구 2명과 맛집 위주로"</em><br><br>인원, 장소, 기간, 취향을 포함하면 더 정확한 추천을 받을 수 있어요!`,
